...
cdll.LoadLibrary(YOUR_PATH + '\\build\\x64\\vc15\\bin\\opencv_world460.dll')
cdll.LoadLibrary(YOUR_PATH + "\\build\\x64\\vc15\\bin\\opencv_world460d.dll') 
...
PMLIB = ctypes.CDLL(REST_OF_YOUR_PATH + '\\PyPatchMatchWin.dll')
